...
<!--------------------------------사진 더보기 기능 및 화면 구현 ----------------------------------------->
        ...
        <div id="photoAddView-area">
            ...
            <div id="top-photo-area"> 
                <a class="left-btn"><img src="/resources/image/left-btn3.png"></a>
                
                <div id="big-photo">
                    <div id="align-area"><img id="insert-img"></div>
                </div>
              
                <a class="right-btn"><img src="/resources/image/right-btn2.png"></a> 
            </div> 
...
<!---------------------------------- 식당 상세정보 ------------------------------------->
        <div id="detail-area">
            ...
            <div>
                <h1 id="store-name" style="font-weight:bold">getPlaceName() </h1>
            </div>
            ...
            <div id="star-score-area">
                <p>
                    ...
                    <span>
                    		<img style="display:inline-block" width="20px" height="20px" src="/resources/image/star1.png"/>
                    		<img style="display:inline-block" width="20px" height="20px" src="/resources/image/star2.png"/>
							<img style="display:inline-block" width="20px" height="20px" src="/resources/image/star2.png"/>                    	
                    </span>
                    <span><>??점</span>
                    <span><a href="#review-info">getCountReview() 명</a></span>
                </p>
            </div>
