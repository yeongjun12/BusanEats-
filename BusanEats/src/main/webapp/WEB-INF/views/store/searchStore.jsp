...
<div class="container">
	...
	<h3 align="center" id="restaurantTitle" style="color: #ff6600;">
    <span style="font-weight: bold;">${requestScope.query}</span> 맛집 인기 검색 순위
	</h3>
    ...
    <div class="grid-container">
        ...
        <c:forEach items="${ requestScope.searchResults }" var="s">
